...
class ArrayBinaryTest extends FunSuite {
  test("main") {
    ...
    assert(pickle.toString === "BinaryPickle([0,0,0,28,115,99,97,108,97,46,112,105,99,107,108,105,110,103,46,97,114,114,97,121,98,105,110,97,114,121,46,67,0,0,0,3,1,0,0,0,2,0,0,0,3,0,0,0])")
