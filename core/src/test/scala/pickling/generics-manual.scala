...
class GenericsManualTest extends FunSuite {
  test("main") {
    ...
    assert(p.value.asInstanceOf[Array[Byte]].mkString("[", ",", "]") === "[0,0,0,37,115,99,97,108,97,46,112,105,99,107,108,105,110,103,46,103,101,110,101,114,105,99,115,109,97,110,117,97,108,46,71,101,110,101,114,105,99,0,0,0,36,115,99,97,108,97,46,112,105,99,107,108,105,110,103,46,103,101,110,101,114,105,99,115,109,97,110,117,97,108,46,80,101,114,115,111,110,0,0,0,42]")
