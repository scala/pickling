...
private[scala] trait StdCreators {
  ...
  private[scala] class FixedMirrorTreeCreator(mirror: scala.reflect.api.Mirror[StdCreators.this.type], tree: => Tree) extends TreeCreator {
  ...
  private[scala] class FixedMirrorTypeCreator(mirror: scala.reflect.api.Mirror[StdCreators.this.type], tpe: => Type) extends TypeCreator {
