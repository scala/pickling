...
// ------ toString -------------------------------------------------------------------
    ...
    final def keyString: String =
      ...
      else if (isTypeMacro) "macro type" // macro type, not type macro!
                                         // this is intentional, so that the user always sees a uniform name
                                         // if you need to distinguish between macro types and type macros for debugging purposes
                                         // consider using -Yshow-symkinds
