...
object MyBuild extends Build {
  ...
  lazy val benchmark: Project = Project(
    ...
    settings = buildSettings ++ Seq(
      ...
      InputKey[Unit]("geoTrellisPick")     <<= benchTask("GeoTrellisPicklingBench", 100000 to 1000000 by 100000),
      InputKey[Unit]("geoTrellisJava")     <<= benchTask("GeoTrellisJavaBench", 100000 to 1000000 by 100000),
      InputKey[Unit]("geoTrellisKryo")     <<= benchTask("GeoTrellisKryoBench", 100000 to 1000000 by 100000),
