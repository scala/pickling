        ...
        val hardcodeDeps = new RewriteRule {
          override def transform(n: XmlNode): XmlNodeSeq = n match {
            case e: Elem if e != null && e.label == "dependencies" =>
              // NOTE: this is necessary to unbind from non-paradise scala-library
              // unfortunately I don't know how to do this otherwise
              // maybe the new sbt 0.13 thing will help us with that
              <dependencies>
                <dependency>
