...
**Current version:** 0.8.0-SNAPSHOT. Scala/pickling does not yet have a stable release. *Scala/pickling is in the early development stages, and any user feedback is highly appreciated!*
